...
@pytest.mark.parametrize(
    "column_resolution, N_p, has_binding, expected_keyword",
    [
...
def test_int_filmDiff_single_particle():
    ...
    result = eq.int_filmDiff_term(particle, 1, 1, singleParticle=True, nonLimitingFilmDiff=False, hasSurfDiff=False)
...
def test_int_filmDiff_multiple_particles():
    ...
    particle = _make_particle(surface_volume_ratio=3, resolution="1D")
    result = eq.int_filmDiff_term(particle, 1, 3, singleParticle=False, nonLimitingFilmDiff=False, hasSurfDiff=False)
...
def test_int_filmDiff_nonlimiting_0D_returns_empty():
    ...
    result = eq.int_filmDiff_term(particle, 1, 1, singleParticle=True, nonLimitingFilmDiff=True, hasSurfDiff=False)
    assert result == ""
...
def test_int_filmDiff_nonlimiting_1D_substitutes_BC():
    ...
    particle = _make_particle(surface_volume_ratio=3, resolution="1D")
    result = eq.int_filmDiff_term(particle, 1, 1, singleParticle=False, nonLimitingFilmDiff=True, hasSurfDiff=False)
...
def test_int_filmDiff_nonlimiting_with_surfDiff():
    ...
    particle = _make_particle(surface_volume_ratio=3, resolution="1D")
    result = eq.int_filmDiff_term(particle, 1, 1, singleParticle=False, nonLimitingFilmDiff=True, hasSurfDiff=True)
...
@pytest.mark.unit_test
@pytest.mark.parametrize(
    "resolution, includeParLiquid, has_bulk, has_par",
    [
        ("1D", False, True, False),
        ("1D", True, True, True),
        ("2D", False, True, False),
...
@pytest.mark.unit_test
@pytest.mark.parametrize(
    "resolution, geometry, has_binding, expected_frag",
    [
...
def test_particle_transport_radial_geometry(geometry, expected_frag):
    ...
    result = eq.particle_transport_radial(
        geometry, has_surfDiff=False, has_binding=True, req_binding=False, has_mult_bnd_states=False
    )
    assert expected_frag in result
...
def test_particle_transport_radial_surfDiff_toggle():
    ...
    with_sd = eq.particle_transport_radial(
        "Sphere", has_surfDiff=True, has_binding=True, req_binding=False, has_mult_bnd_states=False
    )
...
def test_particle_transport_radial_req_binding():
    ...
    result = eq.particle_transport_radial(
        "Sphere", has_surfDiff=False, has_binding=True, req_binding=True, has_mult_bnd_states=False
    )
...
def test_particle_transport_radial_no_binding():
    ...
    result = eq.particle_transport_radial(
        "Sphere", has_surfDiff=False, has_binding=False, req_binding=False, has_mult_bnd_states=False
    )
...
def test_particle_transport_radial_mult_bnd_states():
    ...
    result = eq.particle_transport_radial(
        "Sphere", has_surfDiff=False, has_binding=True, req_binding=False, has_mult_bnd_states=True
    )
...
def test_particle_transport_homogeneous_liquid_binding_toggle():
    ...
    with_bnd = eq.particle_transport_homogeneous_liquid(has_binding=True, req_binding=False, has_mult_bnd_states=False)
...
def test_particle_transport_homogeneous_solid_req_binding():
    ...
    result = eq.particle_transport_homogeneous_solid(req_binding=True, has_mult_bnd_states=False)
    assert "0" in result
...
def test_particle_transport_homogeneous_combined():
    ...
    result = eq.particle_transport_homogeneous(has_binding=True, req_binding=False, has_mult_bnd_states=False)
...
@pytest.mark.unit_test
@pytest.mark.parametrize(
    "binding_model, expected_fragment",
    [
...
def test_particle_transport_homogeneous_binding_model(binding_model, expected_fragment):
    ...
    result = eq.particle_transport_homogeneous(
        has_binding=True, req_binding=False, has_mult_bnd_states=False, binding_model=binding_model
    )
    assert expected_fragment in result
...
@pytest.mark.unit_test
@pytest.mark.parametrize(
    "binding_model, expected_keyword",
    [
