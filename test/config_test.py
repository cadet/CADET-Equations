...
untested_variables = ["dev_mode", "advanced_mode", "var_format", "param_table", "show_eq_description", "PSD", "PTD"] # dev_mode is not tested, TODO: test the advanced_mode (which includes PSD, PTD)
