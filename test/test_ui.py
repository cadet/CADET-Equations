...
untested_variables = ["dev_mode", "advanced_mode", "var_format", "sym_table", "show_eq_description", "PSD", "PTD", "has_filter", "has_reaction_bulk", "has_reaction_particle_liquid", "has_reaction_particle_solid"]
