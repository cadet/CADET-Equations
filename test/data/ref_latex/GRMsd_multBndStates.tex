...
\begin{align}
\frac{\partial c^{\mathrm{p}}_{i}}{\partial t} &= \frac{1}{r^2} \frac{\partial }{\partial r} \left( r^2 D_{i}^{\mathrm{p}} \frac{\partial c^{\mathrm{p}}_{i}}{\partial r} \right) - \frac{1 - \varepsilon^{\mathrm{p}}}{\varepsilon^{\mathrm{p}}}\sum_{k=1}^{N^{\mathrm{b}}_{i}} f^{\mathrm{bind}}_{i,k}\left( \vec{c}^{\mathrm{p}}, \vec{c}^{\mathrm{s}} \right), \\
