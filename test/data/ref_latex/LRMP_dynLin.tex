...
\section*{Lumped Rate Model with Pores with Linear binding}
...
\begin{align}
          ...
          &=\frac{3}{R^{\mathrm{p}}} k^\mathrm{f}_{i} \left( c^{\mathrm{b}}_{i} - c^{\mathrm{p}}_{i} \right) - \left( 1 - \varepsilon^{\mathrm{p}} \right) \left(k^{\mathrm{a}}_{i} c^{\mathrm{p}}_{i} - k^{\mathrm{d}}_{i} c^{\mathrm{s}}_{i} \right),\\

          \frac{\partial c^{\mathrm{s}}_{i}}{\partial t}
          &= k^{\mathrm{a}}_{i} c^{\mathrm{p}}_{i} - k^{\mathrm{d}}_{i} c^{\mathrm{s}}_{i} .
\end{align}

Here, $c^{\mathrm{p}}_{i}\colon (0, T^\mathrm{end}) \times (0, L) \mapsto \mathbb{R}$ is the particle liquid concentration, $c^{\mathrm{s}}_{i}\colon (0, T^\mathrm{end}) \times (0, L) \mapsto \mathbb{R}$ is the particle solid concentration, $k^{\mathrm{a}}_{i}$ is the adsorption rate constant, and $k^{\mathrm{d}}_{i}$ is the desorption rate constant.
