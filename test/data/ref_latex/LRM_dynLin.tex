...
\section*{Lumped Rate Model without Pores with Linear binding}
...
\begin{align}
          ...
          &= k^{\mathrm{a}}_{i} c^{\mathrm{\ell}}_{i} - k^{\mathrm{d}}_{i} c^{\mathrm{s}}_{i} , \end{align}
Here, $c^{\mathrm{s}}_{i}\colon (0, T^\mathrm{end}) \times (0, L) \mapsto \mathbb{R}$ is the particle solid concentration, $k^{\mathrm{a}}_{i}$ is the adsorption rate constant, and $k^{\mathrm{d}}_{i}$ is the desorption rate constant.
