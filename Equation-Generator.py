...
uploaded_file = st.sidebar.file_uploader(
    "Define the model configuration below or upload a configuration file, which can either be a CADET h5 simulation file or a simplistic json file generated by CADET-Equations", type=["json", "h5"])
